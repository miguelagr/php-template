...
<?php
    ...
    if (isset($_POST["agregar"])){
        require 'classes.php';
        $product = new car_prod();
        echo $product->addProduct($_POST['id']);
    }
?>
</head>
<body>
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <button class="btn btn-outline-success my-2 my-sm-0 right" onclick="window.location.href='carrito.php'" type="submit">Carrito</button>
  </div>
</nav>
             ...
             <div class="card container" style="width:230px">
                ...
                <div class="card-body">
                  ...
                  <?php }else{ echo "Agregar al carrito"; ?>
                    ">
                  <?php } ?>
                  <input type="hidden" name="id" value="<?php echo $arr["producto_id"]; ?>" hidden>
                  </form>
                </div>
            </div>
